        ...
        <div className="flex-1 space-y-6">
            ...
            <div className="bg-white dark:bg-secondary-900 rounded-2xl border border-secondary-100 dark:border-secondary-800 shadow-card overflow-hidden transition-colors">
                <div className="p-4 border-b border-secondary-100 dark:border-secondary-800 flex justify-between items-center bg-white dark:bg-secondary-900">
                    <h2 className="text-base font-bold text-secondary-900 dark:text-secondary-100">Company Coupons</h2>
                    ...
                    <table className="w-full border-collapse">
                        <thead>
                            <tr className="bg-white dark:bg-secondary-900 border-b border-secondary-100 dark:border-secondary-800">
                                ...
                                <th className="px-6 py-4 text-center text-sm font-bold text-secondary-900 dark:text-secondary-100 border-r border-secondary-50 dark:border-secondary-800">Coupon count</th>
                                <th className="px-6 py-4 text-center text-sm font-bold text-secondary-900 dark:text-secondary-100">Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            {allocationData.map((row) => (
                                <tr key={row.id} className="border-b border-secondary-50 dark:border-secondary-800 hover:bg-secondary-50/30 dark:hover:bg-secondary-800/30 transition-colors group">
                                    <td className="px-6 py-4 text-sm text-secondary-800 dark:text-secondary-200 font-medium border-r border-secondary-50 dark:border-secondary-800 text-center">{row.name}</td>
                                    <td className="px-6 py-4 text-sm text-secondary-800 dark:text-secondary-200 border-r border-secondary-50 dark:border-secondary-800 text-center">{row.email}</td>
                                    <td className="px-6 py-4 text-sm text-secondary-800 dark:text-secondary-200 border-r border-secondary-50 dark:border-secondary-800 text-center">{row.number}</td>
                                    <td className="px-6 py-4 text-sm text-secondary-800 dark:text-secondary-200 border-r border-secondary-50 dark:border-secondary-800 text-center">{row.status}</td>
                                    <td className="px-6 py-4 text-sm text-secondary-800 dark:text-secondary-200 border-r border-secondary-50 dark:border-secondary-800 text-center">{row.couponCount}</td>
                                    <td className="px-6 py-4 text-center">
                                        <button className="flex items-center justify-center gap-2 mx-auto text-secondary-600 dark:text-secondary-400 hover:text-primary dark:hover:text-primary transition-colors group/btn">
                ...
                <div className="p-4 flex justify-end items-center bg-white dark:bg-secondary-900 border-t border-secondary-100 dark:border-secondary-800 transition-colors">
                    <div className="flex items-center gap-1">
                        <button className="p-2 text-secondary-400 dark:text-secondary-600 hover:text-secondary-900 dark:hover:text-secondary-100 transition-colors disabled:opacity-30 disabled:cursor-not-allowed">
                        ...
                        <button className="px-3 py-1 text-sm font-medium text-secondary-500 dark:text-secondary-400 hover:text-secondary-900 dark:hover:text-secondary-100 transition-colors">
                            0
                        </button>
                        ...
                        <button className="p-2 text-secondary-600 dark:text-secondary-400 hover:text-secondary-900 dark:hover:text-secondary-100 transition-colors">
