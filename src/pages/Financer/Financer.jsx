...
const INITIAL_DATA = [
    { id: 1, image: "Png", name: "Home Credit", status: "Active" },
    { id: 2, image: "Png", name: "Bank of America", status: "Active" },
    { id: 3, image: "Png", name: "Citibank", status: "Active" },
    { id: 4, image: "Png", name: "ICICI Bank", status: "Active" },
];
    ...
    return (
        <div className="min-h-screen bg-gray-50 font-sans">
            ...
            <div className="bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between">
                <h1 className="text-2xl font-bold text-purple-600 tracking-tight">Financer</h1>
            ...
            <div className="p-6">
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div className="bg-purple-100 px-6 py-4 flex items-center justify-between">
                        <h2 className="text-purple-700 font-bold text-base">Financer List</h2>
                        ...
                        <table className="w-full text-sm border-collapse">
                            <thead>
                                <tr className="border-b border-gray-200">
                                    <th className="px-6 py-3 text-center text-sm font-bold text-gray-700 w-28">Image</th>
                                    ...
                                    paginatedData.map((row) => (
                                        <tr key={row.id} className="border-b border-gray-50 hover:bg-purple-50/20 transition-colors">
                                            <td className="px-6 py-6 text-center align-middle">
                                                <span className="text-sm text-gray-500">{row.image}</span>
                                            </td>
                                            <td className="px-6 py-6 text-center align-middle text-gray-700 font-medium">{row.name}</td>
                                            <td className="px-6 py-6 text-center align-middle">
