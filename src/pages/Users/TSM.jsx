...
const PageHeader = () => (
    <div className="bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between">
        <h1 className="text-2xl font-bold text-purple-600 tracking-tight">TSM</h1>
...
const RowActions = () => (
    <div className="flex flex-col gap-1.5">
        <div className="flex gap-1.5">
            ...
            <button className="text-xs font-semibold px-3 py-1.5 bg-purple-600 hover:bg-purple-700 text-white rounded-lg transition-colors">Seller</button>
        </div>
        <div className="flex gap-1.5">
            <button className="text-xs font-semibold px-3 py-1.5 bg-green-500 hover:bg-green-600 text-white rounded-lg transition-colors">Add Seller</button>
            <button className="text-xs font-semibold px-3 py-1.5 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-lg transition-colors">Return to Distributor</button>
        </div>
        <button className="text-xs font-semibold px-3 py-1.5 bg-purple-100 hover:bg-purple-200 text-purple-700 rounded-lg transition-colors w-fit">Assign Coupon</button>
    </div>
);

const GRID_COLS = "grid-cols-[1.3fr_1.6fr_1fr_1fr_0.7fr_1fr_1.8fr]";
...
function TSM() {
    ...
    const filteredData = useMemo(() => {
        ...
        return INITIAL_DATA.filter((d) => d.name.toLowerCase().includes(query) || d.id.toLowerCase().includes(query));
    }, [search]);
            ...
            <div className="p-6">
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    <div className="bg-purple-100 px-6 py-4 flex items-center justify-between">
                        <h2 className="text-purple-700 font-bold text-base">TSM list</h2>
